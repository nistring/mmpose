...
from .inference import (collect_multi_frames, inference_bottomup,
                        inference_topdown, batch_inference_topdown, batch_inference_detector, init_model)
...
__all__ = [
    'init_model', 'inference_topdown', 'batch_inference_topdown', 'inference_bottomup', 'batch_inference_detector',
